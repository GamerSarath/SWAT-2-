...
public class EnemyShooter : MonoBehaviour
{
    ...
    void RPC_EnemyGiveDamage(float damage)
    {
        ...
        EnemyNavigationScript.instance.focusPlayer.GetComponent< PlayerMovement>(). currentHealth -= damage;
        EnemyNavigationScript.instance.focusPlayer.GetComponent<PlayerMovement>().healthbarSlider.value = EnemyNavigationScript.instance.focusPlayer.GetComponent<PlayerMovement>().currentHealth;
        if (EnemyNavigationScript.instance.focusPlayer.GetComponent<PlayerMovement>().currentHealth <= 0)
        {
            EnemyNavigationScript.instance.focusPlayer.GetComponent<PlayerMovement>().currentHealth = 0;
            EnemyNavigationScript.instance.focusPlayer.GetComponent<PlayerMovement>().ApplyDamage(0);
        }
        // Debug.Log("Damage taken" + damage);
        // Debug.Log("Current Health is" + currentHealth);
